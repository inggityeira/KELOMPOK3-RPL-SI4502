...
<div style="margin-top:30px; margin-left:50px;">
    ...
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/profil-Org" style="color:white; font-size:20px; text-decoration: none; letter-spacing:1px;font-size:18px;"><strong>Profil</strong></a></li>
            <li class="breadcrumb-item"><a href="{{ route('edit-organisasi', ['id' => $user->id_user]) }}" style="color:white; font-size:20px; text-decoration: underline; letter-spacing:1px; font-size:18px;"><strong>Edit Profil</strong></a></li>
        </ol>
    </nav>
</div>
