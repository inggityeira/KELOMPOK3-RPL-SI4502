...
<nav class="navbar navbar-expand-lg bg-transparent position-relative" style="margin-right: 100px; margin-bottom: -2%; height:100px;">
    <a href="/home" style="padding:0px;"><h2><img src="/img/LOGO.png" alt="Laborare" style="width:90%; margin-left:10px; margin-top:-35px;"></h2></a>
    <div style="display: flex; justify-content: center;">

        <ul class="navbar-nav top-10" style="font-size: 18px;  margin-top:-30px; letter-spacing:5px; margin-left: auto; margin-right: auto;">
            <li class="nav-item">
