...
<body>
    ...
    <div class="background-image" style="background-image: url('/img/landing.png'); height: 570px; background-size: cover; background-position: center; margin-top: -2%;">
