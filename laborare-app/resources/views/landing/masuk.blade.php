...
<body>
    ...
    <div class="background-image d-flex flex-column justify-content-center align-items-center"
        style="background-image: url('/img/masuk.png'); height: 570px; background-size: 100% 100%; background-position: center; margin-top: -2%;">
        ...
        <div>
            ...
            <p style="color: white; font-size: 15px; font-weight: 400; text-align: center;">Buat akun? <a href="/daftar"
                    class="primary-text fw-medium" style=" color:white;">Daftar</a></p>
        </div>
    </div>
</body>
