...
<div style="margin-top:20px; margin-left:50px;">
  <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
      <ol class="breadcrumb">
          <li class="breadcrumb-item active"><a href="{{'listkegiatan-Ind'}}" style="color:white; font-size:20px; text-decoration: underline; letter-spacing:1px;">Kegiatan</a></li>
      </ol>
  </nav>
</div>
...
{{-- Notes: Tambahin href --}}
<div class="col">
  <a href="/progresskegiatan" id= "btn-kegiatan-yang-diikuti" class="btn btn-light fw-bolder" style="font-size:15px; margin-top:10px; margin-right:-100px;">Kegiatan yang diikuti</a>
</div>
