...
@section('content')
    ...
    <div style="margin-top:30px; margin-left:50px;">
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a
                        href="{{ route('laporsukarelawan-Org', ['id' => $kegiatan->id_kegiatan]) }}"
                        style="color:white; font-size:20px; text-decoration: none; letter-spacing:1px;">Sukarelawan</a></li>
                <li class="breadcrumb-item active"><a href="{{ url()->current() }}"
                        style="color:white; font-size:20px; text-decoration: underline; letter-spacing:1px;">Laporkan</a>
                </li>
            </ol>
        </nav>
    </div>
    ...
    <div style="display: flex; justify-content: center; align-items: center;">
        <div style="width: 700px;">
            <form action="{{ route('laporkan', ['id' => $sukarelawan->id_sukarelawan]) }}" method="POST"
