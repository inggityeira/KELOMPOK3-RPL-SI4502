        ...
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a
                        href="{{ route('detailkegiatan-Org', ['id' => $kegiatan->id_kegiatan]) }}"
                ...
                <li class="breadcrumb-item active"><a href="{{ url()->current() }}"
                        style="color:white; font-size:20px; text-decoration: underline; letter-spacing:1px;">Sukarelawan</a>
                </li>
            </ol>
        </nav>
    </div>
        ...
        <table class="table-striped table-dark table">
            ...
            <tbody>
                @foreach ($sukarelawan as $people)
                    <tr>
                        <td class="identitas">
                            <img src="{{ asset('pasfoto/' . $people->pas_foto) }}" alt="" width="100px"
                                style="margin-right: 20px;"> {{ $people->user->nama_user }}
                        </td>
                        ...
                        <td class="sukarelawan py-4">
                            @if ($people->status_sukarelawan != 'Selesai')
                                <a href="{{ route('formlaporan-Org', ['id_kegiatan' => $people->id_kegiatan, 'id' => $people->id_sukarelawan]) }}"
                                    class="btn" style="background-color: #4A47FF; color:white;">
