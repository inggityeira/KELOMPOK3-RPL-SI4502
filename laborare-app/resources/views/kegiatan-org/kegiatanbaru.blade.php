    ...
    <div style="margin-top:30px; margin-left:50px;">
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="/kegiatanbaru-Org"
                        style="color:white; font-size:20px; text-decoration: underline; letter-spacing:1px;">Kegiatan
                        Baru</a></li>
            </ol>
        </nav>
    </div>
    ...
    <div class="containerbawah">
        <form class="row g-2" action="{{ route('tambahkegiatan') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-12">
                ...
                <input type="text" id="activityName" name="activityName" value="{{ old('activityName') }}"
