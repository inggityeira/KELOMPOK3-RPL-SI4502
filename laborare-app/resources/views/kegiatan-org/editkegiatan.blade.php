    ...
    <div style="margin-top:30px; margin-left:50px;">
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="{{ route('detailkegiatan-Org', $kegiatan->id_kegiatan) }}"
                        style="color:white; font-size:20px; text-decoration: none; letter-spacing:1px;">Detail Kegiatan</a>
                </li>
    ...
    <div class="containerbawah">
        <form class="row g-2" action="{{ route('updatekegiatan', ['id' => $kegiatan->id_kegiatan]) }}" method="POST"
            ...
            <div class="col-12">
                ...
                <input type="text" id="activityName" name="activityName" value="{{ $kegiatan->nama_kegiatan }}"
            ...
            <div class="col-12">
                ...
                <input type="date" id="activityDate" name="activityDate" style="background-color: #CBCBCB;"
            ...
            <div class="col-12">
                ...
                <select id="activityCategory" name="activityCategory" style="background-color: #CBCBCB;">
                    <option selected value="{{ $kegiatan->kategori_kegiatan }}">{{ $kegiatan->kategori_kegiatan }}
                    </option>
            ...
            <div class="col-12">
                ...
                <input id="activityDescription" name="activityDescription" style="background-color: #CBCBCB;"
                    value="{{ $kegiatan->deskripsi_kegiatan }}">
                <span class="text-danger">
