        ...
        <form action="{{ route('pembayarandonasi_store', ['id' => $donasi->id_donasi]) }}" method="POST">
            ...
            <div class="row mb-3">
                <div class="col-5 text-end">
                    <img src="{{ asset('donasi/' . $donasi->sampul_donasi) }}" width="300px;" height="300px;"
                        alt="{{ $donasi->nama_donasi }}">
                </div>
                ...
                <div class="col-5" style="margin-top: 50px;">
                    ...
                    <div class="my-3">
                        ...
                        <input name="nominal" type="number" class="form-control" style="background-color: #FFFFFF;"
                            required>
                    </div>
                </div>
            ...
            <div class="d-flex flex-column align-items-center">
                <div class="mb-3" style="width: 700px;">
                    ...
                    <div style="background-color: #FFFFFF; color:black;" class="p-2 px-3 rounded">{{ $user->nama_user }}
                    </div>
                </div>
                <div class="mb-3" style="width: 700px;">
                ...
                <button type="submit" class="btn btn-light text-dark"
                    style="width: 150px;"><strong>Donasi</strong></button>
            </div>
        </form>
    </div>
@endsection
